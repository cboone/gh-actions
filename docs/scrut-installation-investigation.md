...
The corrected audit jobs all passed in [Run CI 35121681109](https://github.com/cboone/gh-actions/actions/runs/35121681109) at `70a9ed165fd2f460a2647f8db83980b028ec0130`. Downloaded artifacts establish original extracted mode 0755 for all 32 archives, one successful executed snapshot case for all 16 correctly packaged native assets, and the expected kernel architecture rejection for all 16 defective assets.

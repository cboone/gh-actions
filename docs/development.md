...
Read this before changing an action, workflow, dependency pin, component reference or release. Code-span paths are relative to the repository root. See [root instructions](../AGENTS.md) for commands and merge policy.
